...
func main() {
	...
	fmt.Println("\nОбъяснение: в срез на каждой итерации добавлялся один и тот же указатель &b; после цикла b == 3, поэтому все три элемента указывают на один адрес со значением 3. double() удваивает значение по этому адресу лишь один раз -> 6 6 6.")
